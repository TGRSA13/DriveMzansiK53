...
document.addEventListener('DOMContentLoaded', function() {
  ...
  nextButton.addEventListener('click', function(event) {
      ...
      // Get the selected answer (assuming the answers are radio buttons with name 'rule-question')
      const selectedAnswer = document.querySelector('input[name="rule-question1"]:checked');
      ...
      localStorage.setItem('rule-question1', selectedAnswer.value.charAt(0)); // Save only the letter of the answer
          ...
          window.location.href = 'rules_question2.html';  // Replace with your actual next question page
