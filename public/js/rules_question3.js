...
document.addEventListener('DOMContentLoaded', function() {
  ...
  nextButton.addEventListener('click', function(event) {
      ...
      const selectedAnswer = document.querySelector('input[name="rule-question3"]:checked');
      ...
      localStorage.setItem('rule-question3', selectedAnswer.value.charAt(0)); // Save only the letter of the answer
          ...
          window.location.href = 'signs_question1.html';  // Replace with your actual next question page
