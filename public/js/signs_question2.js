...
localStorage.setItem('sign-question2', selectedAnswer.value.charAt(0)); // Save only the letter of the answer

          // Save the remaining time
          localStorage.setItem('quizTimeLeft', timeLeft);

          // Redirect to the next question page
          window.location.href = 'signs_question3.html';  // Replace with your actual next question page
